...
function addxobad() {
    try {
        ...
        $('#' + aa).html('<img src=\"http://img.homepagemodules.de/xl16c.png\" alt=\"Xobor.de\"><a style=\"text-decoration:none; color: #8d8d8d;\" href=\"http://www.xobor.de\">&ensp;Einfach ein eigenes Xobor Forum erstellen</a>');
        ssc(aa);
